# Generated by Django 4.1 on 2022-08-30 10:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_confirmed', models.BooleanField(default=True, verbose_name='確定済み')),
            ],
            options={
                'verbose_name': '候補',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.suggestion', verbose_name='タイトル')),
            ],
            options={
                'verbose_name': '予定',
